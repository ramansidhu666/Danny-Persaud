...
function PostCard_Data() {
    ...
    if ($('#<%=hdnTemplateType.ClientID %>').val() == "Openhouse") {
        ...
        $('#close_popup').removeClass();
        $('#close_popup').addClass('clos-btn-div-FirstPostCard');
    }
    else if ($('#<%=hdnTemplateType.ClientID %>').val() == "feature") {
        ...
        $('#close_popup').removeClass();
        $('#close_popup').addClass('clos-btn-div-SecondPostCard');
    }
    else if ($('#<%=hdnTemplateType.ClientID %>').val() == "2ndfeature") {
        $('#mypopup').addClass('scnd_postcard');
        ...
        data = "{First_feature_cntnt: '" + First_feature_cntnt + "', Second_feature_cntnt: '" + Second_feature_cntnt + "', Thirld_feature_cntnt: '" + Thirld_feature_cntnt + "', Fourth_feature_cntnt: '" + Fourth_feature_cntnt + "'}";
        $('#close_popup').removeClass();
        $('#close_popup').addClass('clos-btn-div-ThirldPostCard');
    }
    else if ($('#<%=hdnTemplateType.ClientID %>').val() == "jst_sold") {
        $('#mypopup').addClass('scnd_postcard');
        ...
        $('#close_popup').removeClass();
        $('#close_popup').addClass('clos-btn-div-FourthPostCard');
    }
    return data;
}
                ...
                <div class="form-horizontal row-fluid">
                        ...
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 60%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    ...
                                    <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Danny Persaud</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 647-718-0744</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: sold@dpfs.ca</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.dpfs.ca</p>
                        ...
                        <div id="feature_Front" style="float: left; width: 99%; background-color: #FFF; display: none; padding: 12px;">
                            ...
                            <div style="float: left; width: 97%; margin: 8px 0; background-color: #1c1b1d; padding: 6px;">
                                <div style="float: left; width: 35%;">
                                    <img src="/PostCardImages/client_img.jpg" alt="" title="" style="width: 80%;">
                                </div>
                    ...
                    <div class="newsltr_bg" id="feature_Back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Danny Persaud(Broker of Record)</h2>
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Danny Persaud</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">Homelife / Miracle Realty Ltd,. Brokerage</p>
                            </div>
                        </div>
                    </div>
